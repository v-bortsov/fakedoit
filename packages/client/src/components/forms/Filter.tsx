...
import { updFieldValueByColumn } from '../../constants/Actions';


const FilterForm = ({uniq, total, shuffle, byColumn, dispatch}: FilterType) => {
      ...
      <View style={{ flex: 1, padding: 10 }}>
        ...
        <SelectDropdown
          ...
          onSelect={(
            ...
            updFieldValueByColumn({dispatch, path: ['limiting'], value: selectedItem})
          }}
